...
let apiKey = `https://api.voicerss.org/?key=e5f3e006e1094858bc2a60f8a2f0e228&hl=en-us&v=Clara&src=${VoiceRSS}`


function tellMeAJoke(joke){
   
    VoiceRSS.speech({
        key: 'e5f3e006e1094858bc2a60f8a2f0e228',
        src: `${joke}`,
        hl: 'en-us',
        v: 'Clara',
        r: 0, 
...
async function getJokes(){
    ...
    const jokeApiRequestSting = 'https://v2.jokeapi.dev/joke/Dark,Pun'
    try {
        const response = await fetch(jokeApiRequestSting)
